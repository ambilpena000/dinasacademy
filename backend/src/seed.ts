...
const TRYOUTS: TryoutSeed[] = [
  ...
  },
  {
    ...
    description: 'Latihan intensif untuk membangun fondasi SNBT 2026',
    category: 'PTN',
    difficulty: 'Mudah',
    duration: 195,
    totalQuestions: 160,
  ...
  },
  {
    ...
    description: 'Simulasi pemantapan materi TPS & Literasi SNBT 2026',
    category: 'PTN',
    difficulty: 'Sedang',
    duration: 195,
    totalQuestions: 160,
  ...
  {
    title: 'Try Out SNBT 2026 #5',
    description: 'Simulasi prediksi akurat UTBK SNBT 2026',
    category: 'PTN',
    difficulty: 'Sulit',
    duration: 195,
    totalQuestions: 160,
  ...
  {
    title: 'Try Out SNBT 2026 #6',
    description: 'Try Out final jelang pelaksanaan UTBK SNBT 2026',
    category: 'PTN',
    difficulty: 'Sedang',
    duration: 195,
    totalQuestions: 160,
  ...
  // 6 Try Out SKD Sekdin
  {
    title: 'Try Out SKD Sekdin 2026 #1',
    description: 'Simulasi CAT SKD sesuai kisi-kisi resmi BKN 2026',
    category: 'SKD',
    difficulty: 'Sedang',
    duration: 100,
    totalQuestions: 110,
    isActive: true,
    isLocked: false,
    subjects: skdSubjects,
  },
  {
    title: 'Try Out SKD Sekdin 2026 #2',
    description: 'Simulasi CAT SKD level advance — penguatan TWK & TIU',
    category: 'SKD',
    difficulty: 'Sulit',
    duration: 100,
    totalQuestions: 110,
  ...
  {
    title: 'Try Out SKD Sekdin 2026 #3',
    description: 'Latihan intensif strategi waktu penyelesaian soal SKD',
    category: 'SKD',
    difficulty: 'Mudah',
    duration: 100,
    totalQuestions: 110,
  ...
  {
    title: 'Try Out SKD Sekdin 2026 #4',
    description: 'Simulasi fokus pemantapan ambang batas (passing grade) SKD',
    category: 'SKD',
    difficulty: 'Sedang',
    duration: 100,
    totalQuestions: 110,
  ...
  {
    title: 'Try Out SKD Sekdin 2026 #5',
    description: 'Simulasi HOTS (Higher Order Thinking Skills) SKD Sekdin 2026',
    category: 'SKD',
    difficulty: 'Sulit',
    duration: 100,
    totalQuestions: 110,
  ...
  {
    title: 'Try Out SKD Sekdin 2026 #6',
    description: 'Try Out CAT final persiapan seleksi Sekolah Kedinasan 2026',
    category: 'SKD',
    difficulty: 'Sedang',
    duration: 100,
    totalQuestions: 110,
